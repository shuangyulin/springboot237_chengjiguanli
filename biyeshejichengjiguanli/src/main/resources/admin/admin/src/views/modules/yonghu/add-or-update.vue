        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="专业" prop="xuekeTypes">
                        <el-select v-model="ruleForm.xuekeTypes" :disabled="ro.xuekeTypes" placeholder="请选择专业">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="专业" prop="xuekeValue">
